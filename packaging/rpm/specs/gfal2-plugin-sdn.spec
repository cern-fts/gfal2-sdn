...
Name:           gfal2-plugin-sdn
Version:        0.0.1
Release:        1%{?dist}
Summary:        Provide SDN feedback support for GFAL2
...
%files
%defattr(-,root,root,-)
%config(noreplace) %{_sysconfdir}/gfal2.d/sdn_plugin.conf
%{_libdir}/%{pkgdir}/libgfal_plugin_sdn.so
%{_pkgdocdir}/*

%changelog
* Tue Mar 10 2015 Alejandro Alvarez Ayllon <aalvarez at cern.ch> - 0.0.1-1
 - Initial release
